...
public:
 ...
 UFUNCTION(BlueprintPure) bool HasStoredMemory(FVector2D Point) const {return bScopeValid && Knowledge.HasMemory(Point);}
...
private:
 ...
 void Publish();
 void Bind();
 FDarkwellStaticKnowledge Knowledge;
 TMap<FIntPoint,int32> Pages;
