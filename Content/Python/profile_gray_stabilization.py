...
def run():
    ...
    elif protocol == 'FrameAudit':
        # Focused trace attribution at unchanged production quality. Matrix is frozen.
        cases = [('Empty',0,300), ('FastSweep160',4,300),
                 ('PartialNewThenRepeat',0,600), ('StationaryStop',0,600)]
