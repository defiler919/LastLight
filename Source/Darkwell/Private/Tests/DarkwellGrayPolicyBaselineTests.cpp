...
namespace Darkwell::GrayPolicyBaseline
{
 struct FMeasurements
 {
  ...
  uint64 Occupancy=0, OccupancyHits=0, GeometryTests=0;
  ...
  {
   Occupancy+=P.OccupancyTests; OccupancyHits+=P.OccupancyCacheHits; GeometryTests+=P.PrimitiveGeometryTests;
