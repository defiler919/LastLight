...
public:
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		SHADER_PARAMETER(FVector2f, TemporalProjectionJitter)
		SHADER_PARAMETER(uint32, DiagnosticMode)
		SHADER_PARAMETER(uint32, UseStableDepthCoordinates)
		SHADER_PARAMETER(uint32, PreTemporalUpscaleComposition)
		SHADER_PARAMETER(uint32, CustomDepthUsesTemporalJitter)
		...
		SHADER_PARAMETER(uint32, StaticEnvironmentStencilValue)
		SHADER_PARAMETER(uint32, OccluderSurfaceStencilValue)
		SHADER_PARAMETER(float, RememberedBrightness)
		SHADER_PARAMETER(float, RememberedContrast)
		SHADER_PARAMETER(float, RememberedDetailStrength)
		SHADER_PARAMETER(float, RememberedDetailWorldScale)
		SHADER_PARAMETER(float, RememberedSurfaceDepthToleranceCentimeters)
		SHADER_PARAMETER(float, OccluderSurfaceBiasCentimeters)
