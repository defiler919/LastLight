...
struct SIGHTWEAVERENDER_API FSightWeaveRenderReadbackResult
{
	...
	double ClearPassSetupMicroseconds = 0.0;
	double RasterVisionSetupMicroseconds = 0.0;
	double RasterIlluminationSetupMicroseconds = 0.0;
	double RasterBypassSetupMicroseconds = 0.0;
	double RasterSuppressionSetupMicroseconds = 0.0;
	double CombinePassSetupMicroseconds = 0.0;
	double GPUWorkMicroseconds = 0.0;
	double ReadbackEndToEndMicroseconds = 0.0;
	uint64 PersistentMaskBytes = 0;
	uint64 ScratchMaskBytes = 0;
	uint64 PacketBufferBytes = 0;
