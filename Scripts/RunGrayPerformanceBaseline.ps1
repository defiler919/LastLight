...
$driver="$repo/Content/Python/profile_gray_stabilization.py"
...
$start=Get-Date
$arguments=@("$repo/Darkwell.uproject",'/Game/Maps/L_SightWeaveGrayPolicyLab','-d3d12','-sm6','-NoSound','-unattended','-NoSplash','-NoVSync','-windowed','-ResX=1920','-ResY=1080','-ForceRes','-WinX=30','-WinY=30',"-abslog=$output/editor.log")
$disabledPlugins=@()
...
$metadata=[ordered]@{
    ...
    driver_sha256=(Get-FileHash $driver).Hash; map='/Game/Maps/L_SightWeaveGrayPolicyLab'; seed=0
